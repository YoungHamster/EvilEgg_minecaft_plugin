...
* schedules synch task that runs every tick with life ticks of the egg */

public final class EvilEgg extends JavaPlugin implements Listener
{

    public static Random rng = new Random();
    private EvilEggManager theEgg = new EvilEggManager(this);
    ...
    public void onBlockPlace(BlockPlaceEvent event){
                                ...
                                event.getBlock().getZ()).getType()))
        {
            ...
            BukkitTask task = theEgg.runTaskTimer(this, 1, 1);
        }
        else
        {
